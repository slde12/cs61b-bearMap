...
public class MapServer {
    ...
    public static final Color ROUTE_STROKE_COLOR = new Color(255, 0, 0, 255);
     ...
     */
    private static void writeImagesToOutputStream(Map<String, Object> rasteredImageParams, ByteArrayOutputStream os) {
     ...
     */
    //public static List<String> getLocationsByPrefix(String prefix) { return autocomplete.prefixSearch(prefix); }
    public static List<String> getLocationsByPrefix(String prefix) { return graph.searchTriePrefix(prefix); }
     ...
     */
    public static List<Map<String, Object>> getLocations(String locationName) { return graph.getLocations(locationName); }
